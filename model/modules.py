...
class Denoiser(nn.Module):
    ...
    def __init__(self, configs):
        ...
        n_mel_channels = configs["preprocessing"]["mel"]["n_mel_channels"]
        d_encoder = configs["transformer"]["encoder_hidden"]
        residual_channels = configs["denoiser"]["residual_channels"]
        residual_layers = configs["denoiser"]["residual_layers"]
        dropout = configs["denoiser"]["denoiser_dropout"]
