...
class DiffSingerLoss(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.loss_config = configs["loss"]
        self.pitch_config = configs["preprocessing"]["pitch"]
        self.pitch_type = self.pitch_config["pitch_type"]
        self.use_pitch_embed = configs["variance_embedding"]["use_pitch_embed"]
        self.use_energy_embed = configs["variance_embedding"]["use_energy_embed"]
        self.energy_feature_level = configs["preprocessing"]["energy"][
            "feature"
        ]
