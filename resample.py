...
if __name__ == "__main__":
    ...
    parser.add_argument("-w", "--wav", help="wav", dest="wav", required=False, default="./dataset_raw")
    parser.add_argument("-o", "--out", help="out", dest="out", required=False, default="./dataset")
    parser.add_argument("-s", "--sr", help="sample rate", dest="sr", type=int, required=False, default=44100)
